...
* ^url = "http://example.org/fhir/StructureDefinition/SLCorePatient"
* ^version = "0.1"
* ^status = #draft
...
* extension contains $SL-core-birthTime named birthTime 0..1
* extension contains $SL-core-religion named religion 0..1
...
* address.extension contains $SLcoreAddExt named SLCoreAddressExtension 0..*
